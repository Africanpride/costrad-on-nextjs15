  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 w-full h-screen">
      <div className="sm:flex sm:col-span-2  justify-center items-center hidden relative">
        ...
        <Card className="overflow-hidden rounded-none  flex flex-col justify-center items-center py-5">
          <CardContent className="p-5 w-full">
            <div className="p-3 md:p-4">
              <div className="flex flex-col gap-4">
                {/* <div className="flex items-center justify-center ">
                  <Avatar as={Link} href={'/'}
                    className={`w-[5.4em] h-[5.4em] text-large bg-purple-800 `}
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-balance text-muted-foreground">
                    Login to Join {siteConfig.shortName}
                  </p>
                </div>
      ...
      {/* <div className="bg-neutral-300 dark:bg-neutral-200 flex justify-center items-center h-auto">
      </div> */}
    </div>
  );
}
