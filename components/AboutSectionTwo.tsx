            ...
            <div className="py-10">
              <div className="text-center mx-auto ">
                ...
                <div className="mt-8 grid gap-3 w-full sm:inline-flex sm:justify-center ">
                  ...
                  <Link
                    className=" px-4 inline-flex  justify-center items-center gap-2 rounded-lg border border-transparent text-background  bg-primary font-medium  hover:bg-firefly  focus:outline-none transition-all text-sm  "
                    href="/institutes"
                  >
                    <svg
