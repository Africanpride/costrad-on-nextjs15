        ...
        <div className=" text-left w-full  p-4 md:p-8  sm:rounded-lg prose-img:rounded-xl max-w-max  prose dark:prose-invert ">
          ...
          <div className="post-body post-content">
            ...
            <p>
              ...
              copyright infringement notification. If you are concerned about
              the privacy of your personal information, you may wish to use an
              agent to report infringing material for you.
            </p>
            <h3 style={{ textAlign: "left" }}>Notifications of infringement</h3>
            <p>
              ...
              DMCA requirements. You may refer to a DMCA takedown notice
              generator or other similar services to avoid making mistake and
              ensure compliance of your Notification.
            </p>
            <p>
              ...
              of access to allegedly infringing material. We may also require a
              court order from a court of competent jurisdiction, as determined
              by us in our sole discretion, before we take any action.
            </p>
            <p>
              ...
              information concerning the removal or restriction of access.
            </p>
            <p>
            ...
            <p>
              ...
              will post a notification on the main page of the Website.
            </p>
            <h3 style={{ textAlign: "left" }}>
            ...
            <p>
              ...
              activity, you may do so via the
