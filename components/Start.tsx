  ...
  return (
    <section
      ...
      <div
        ...
        <Link
          href={'/'}
          className={`${bebas.className} absolute top-4 right-4 md:relative flex items-center justify-end w-full font-bebas`}>
          <div
            className={`md:text-[1.7em] pt-4 text-white ${playfair_display.className}`}>
            The Strategic Voter
          </div>
        </Link>
      ...
      <div className='bg-yellow-700 min-h-dvh relative p-4 md:p-6'>
        ...
        <div className=' relative h-full flex flex-col justify-between items-start z-10'>
          <p className='text-md text-yellow-500 pt-2'>
